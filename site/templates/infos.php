...
-->
					...
					<div class="column ">
					    <div class="content realisations">
								...
								<ul class="description">
									<li>
										<a href="http://www.baldingervuhuu.com/" target="_blank">baldingervuhuu.com</a> <span class="realisationsDetails">maquette (maquettes de <a href="http://www.baldingervuhuu.com/" data-link='bvh' target="_blank">Baldinger•Vu-Huu</a>), animations, responsive, code</span>
									</li>
									<li>
										<a href="http://delure.org/" data-link='delure' target="_blank">delure.org</a> <span class="realisationsDetails">maquette, responsive, code</span>
									</li>
									<li>
			    	...
			    	<div class="column ">
					    <div class="content expositions">
								...
								<ul class="description">
									...
									<li><a href="http://chercherletexte.org/fr/" target="_blank">Chercher le Texte</a>, BNF, Paris (2013)</li>
									<li>Salon du livre, Paris (2013)</li>
									<li>Amnesia/Memoria, Marke.06, Weimar, Allemagne (2010)</li>
									<li>Nooka Show, Red Bull Space de New York, États-Unis (2010)</li>
								</ul>
					    </div>
			    	</div>
<!-- 				</div> -->
