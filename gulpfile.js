...
require('pho-devstack')(gulp, {
  ...
  copy: ['images/sprites/**/*', 'humans.txt', 'favicon.ico', 'bower_components/jquery/jquery.min.js', 'bower_components/modernizr/modernizr.js', 'scripts/balls.pde', 'scripts/plugins.js', 'scripts/layout.js']
});
